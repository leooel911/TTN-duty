        ...
        with st.form("sys_config_form"):
            ...
            with col_c2:
                ...
                if curr_val == "":
                    curr_val = "留白（不顯示文字）"
                idx = (
                    options_list.index(curr_val)
                    if curr_val in options_list
                    else 0
                )
            ...
            btn_save_cfg = st.form_submit_button(
                "💾 儲存全域設定", type="primary"
            )
